...
public:
    ...
    void list_set_int(const CollectionBase& Lst, size_t list_ndx, int64_t value) override;
    void list_set_bool(const CollectionBase& Lst, size_t list_ndx, bool value) override;
    void list_set_float(const CollectionBase& Lst, size_t list_ndx, float value) override;
    void list_set_double(const CollectionBase& Lst, size_t list_ndx, double value) override;
    ...
    void list_insert_int(const CollectionBase& Lst, size_t list_ndx, int64_t value) override;
    void list_insert_bool(const CollectionBase& Lst, size_t list_ndx, bool value) override;
    void list_insert_float(const CollectionBase& Lst, size_t list_ndx, float value) override;
    void list_insert_double(const CollectionBase& Lst, size_t list_ndx, double value) override;
